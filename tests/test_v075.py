...
from nano_vm.ast_engine import eval_condition, ASTEvalError
...
async def test_oc01_otherwise_chain_3level():
    ...
    prog = Program.from_dict({
        "name": "oc01",
        "steps": [
            {"id": "c1", "type": "condition", "condition": "'a'=='b'",
             "then": "leaf_dead", "otherwise": "c2"},
            {"id": "c2", "type": "condition", "condition": "'a'=='b'",
             "then": "leaf_dead", "otherwise": "c3"},
            {"id": "c3", "type": "condition", "condition": "'a'=='a'",
             "then": "leaf_ok", "otherwise": "leaf_dead"},
...
async def test_oc04_symmetric_then_otherwise():
    ...
    prog_then = Program.from_dict({
        "name": "oc04_then",
        "steps": [
            {"id": "c1", "type": "condition", "condition": "'a'=='a'",
             "then": "c2", "otherwise": "leaf_dead"},
            {"id": "c2", "type": "condition", "condition": "'a'=='a'",
             "then": "leaf_t", "otherwise": "leaf_dead"},
    ...
    prog_oth = Program.from_dict({
        ...
        "steps": [
            {"id": "c1", "type": "condition", "condition": "'a'=='b'",
             "then": "leaf_dead", "otherwise": "c2"},
            {"id": "c2", "type": "condition", "condition": "'a'=='a'",
             "then": "leaf_o", "otherwise": "leaf_dead"},
    ...
    prog = Program.from_dict({
        ...
        "steps": [
            {"id": "c1", "type": "condition", "condition": "'a'=='a'",
             "then": "c2", "otherwise": "leaf_dead"},
            {"id": "c2", "type": "condition", "condition": "'a'=='b'",
             "then": "leaf_yes", "otherwise": "leaf_no"},
...
async def test_oc06_regression_then_chain():
    ...
    prog = Program.from_dict({
        ...
        "steps": [
            {"id": "c1", "type": "condition", "condition": "'a'=='a'",
             "then": "c2", "otherwise": "leaf_no"},
            {"id": "c2", "type": "condition", "condition": "'b'=='b'",
             "then": "leaf_yes", "otherwise": "leaf_no"},
            {"id": "leaf_yes", "type": "tool", "tool": "echo", "is_terminal": True},
            {"id": "leaf_no",  "type": "tool", "tool": "echo", "is_terminal": True},
        ],
...
async def test_oc07_regression_2level_otherwise():
    ...
    prog = Program.from_dict({
        ...
        "steps": [
            {"id": "c1", "type": "condition", "condition": "'a'=='b'",
             "then": "leaf_yes", "otherwise": "c2"},
            {"id": "c2", "type": "condition", "condition": "'x'=='y'",
             "then": "leaf_yes", "otherwise": "leaf_no"},
            {"id": "leaf_yes", "type": "tool", "tool": "echo", "is_terminal": True},
            {"id": "leaf_no",  "type": "tool", "tool": "echo", "is_terminal": True},
        ],
